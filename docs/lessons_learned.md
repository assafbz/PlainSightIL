...
## 19. Pitfall: Multi-Branch Version Auto-Bumping Divergence (Merge Conflicts)
...
## 20. Pitfall: Downstream Test Coverage Gate Violations on Merged Code
...
## 21. Pitfall: Static Analysis Failures from Subtyping Sealed Firestore Classes
