...
class AppColors {
  ...
  static Color get baseBg => _isDark
      ...
      : HSLColor.fromAHSL(
          ...
          0.40,
          0.98,
        ).toColor(); // Slate light background

  static Color get surface =>
      _isDark ? const Color(0xFF111827) : const Color(0xFFFFFFFF);

  static Color get surfaceLow =>
      _isDark ? const Color(0xFF181B25) : const Color(0xFFF8FAFC);

  static Color get surfaceContainer =>
      _isDark ? const Color(0xFF1C1F29) : const Color(0xFFF1F5F9);

  static Color get surfaceHigh =>
      _isDark ? const Color(0xFF262A34) : const Color(0xFFE2E8F0);

  static Color get surfaceBright =>
      _isDark ? const Color(0xFF353943) : const Color(0xFFCBD5E1);
  ...
  static Color get onPrimary =>
      _isDark ? const Color(0xFF00354A) : const Color(0xFFFFFFFF);
  ...
  static Color get onSecondary =>
      _isDark ? const Color(0xFF3C0091) : const Color(0xFFFFFFFF);
  ...
  static Color get textSecondary => _isDark
      ...
      : HSLColor.fromAHSL(
          ...
          0.25,
          0.40,
        ).toColor(); // Medium slate grey

  static Color get textTertiary => _isDark
      ? HSLColor.fromAHSL(1.0, 215.0, 0.15, 0.45)
            .toColor() // Dark muted slate
  ...
  static Color get glassBg => _isDark
      ? HSLColor.fromAHSL(0.75, 222.0, 0.40, 0.09)
            .toColor() // rgba(15, 23, 42, 0.75)
      : HSLColor.fromAHSL(
          0.80,
          210.0,
          0.40,
          0.96,
        ).toColor(); // rgba(241, 245, 249, 0.80)
