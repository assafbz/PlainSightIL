...
class AppStateNotifier extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _defaultLocalizedStrings = {
    'en': {
      ...
      'ai_search_desc':
          'Search across all active datasets using natural language.',
      'ai_search_hint':
          'Ask something... (e.g., "Toyota recalls" or "Turkey travel warnings")',
      'ai_search_history': 'Recent Queries',
      'ai_search_thinking': 'Searching datasets...',
      'ai_search_no_history': 'No search history yet.',
      'ai_search_citations': 'Sources & Citations',
      ...
      're_analyze_now_label': 'Re-analyze with AI',
    ...
    'he': {
      ...
      'ai_search_title': 'חיפוש סמנטי באיי',
      'ai_search_desc': 'חיפוש בשפה חופשית בכל מאגרי המידע הפעילים במערכת.',
      'ai_search_hint':
          'שאל שאלה... (למשל: "קריאות לתיקון של טויוטה" או "אזהרת מסע לטורקיה")',
      'ai_search_history': 'חיפושים אחרונים',
      'ai_search_thinking': 'מנתח את מאגרי המידע...',
      'ai_search_no_history': 'אין היסטוריית חיפושים.',
      'ai_search_citations': 'מקורות ואסמכתאות',
      ...
      're_analyze_now_label': 'נתח מחדש עם AI',
