...
class LocalStorage {
  ...
  static Future<void> saveFavorites(List<String> favorites) => _impl.saveFavorites(favorites);
  ...
  static Future<void> saveRecents(List<String> recents) => _impl.saveRecents(recents);

  /// Retrieve the guest session status flag.
  static bool getGuestMode() => _impl.getGuestMode();

  /// Persists the guest session status flag.
  static Future<void> saveGuestMode(bool enabled) => _impl.saveGuestMode(enabled);
}
