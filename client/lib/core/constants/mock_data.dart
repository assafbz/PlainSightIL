...
class MockData {
  ...
  static final List<LocalMarketBondRecordModel> bonds = [
    ...
    LocalMarketBondRecordModel(
      ...
      series: 1230001,
      actualTermToMaturity: 2.5,
      originalTermToMaturity: 3.0,
      redemptionDate: '2028-12-31T00:00:00.000Z',
      coupon: 1.50,
      offeredQuantity: 200.0,
      purchasedQuantity: 180.0,
      additionalPurchased: -20.0,
      averagePrice: 100.12,
      cutoffPrice: 100.10,
      totalFunding: 180.22,
      demandedAmount: 180.0,
      coverRatio: 0.9,
      grossAvgYield: 1.45,
      grossCutoffYield: 1.44,
      lastUpdated: '2026-06-04T12:00:00Z',
      createdAt: '2026-06-04T12:00:00Z',
    ),
  ];
